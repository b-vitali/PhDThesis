...
\section{\gf simulations}
    ...
    \subsection{Entrance system}
        ...
        \begin{figure}   
            ...
            \caption[muEDM \gf: Energy deposit in thin scintillators (log-scale)]{Detail on the lower section of the curve for the average energy deposit in a \bc{400} scintillator for $\Am$ at \SI{28}{MeV\per c} and \SI{128}{MeV\per c}.}
        ...
        \subsubsection{Multiple scattering}
            ...
            \begin{figure}   
                \centering
                \subfloat[\SI{28}{MeV/c} muons in thin scintillators]{\includegraphics[height=5.5cm, keepaspectratio]{Figures/muEDM/Entrance/28mu_angleout_fit.png}\label{fig:muEDM:entrance:ms:28}}
                \hfill
                \subfloat[\SI{128}{MeV/c} muons in thin scintillators]{\includegraphics[height=5.5cm, keepaspectratio]{Figures/muEDM/Entrance/128mu_angleout_fit.png}\label{fig:muEDM:entrance:ms:128}}
                \caption[muEDM \gf: scattering angle in scintillators]{Average scattering angle in different thicknesses of \bc{400} scintillator for $\Am$ at \SI{28}{MeV\per c} and \SI{128}{MeV\per c}. From these plots was found $X_0 = \SI{54.33(12)}{g/cm^2}$.}
        ...
        \subsubsection{Thickness and number of photons}
            ...
            \begin{figure}   
                \centering
                \subfloat[The scintillator SiPM are here `floating'.]{\includegraphics[height=8cm, keepaspectratio]{Figures/muEDM/Entrance/gate_noguide.png}}
                \hfill
                \subfloat[Here the scintillator is in a plexiglass frame, to which the SiPM as connected.]{\includegraphics[height=8cm, keepaspectratio]{Figures/muEDM/Entrance/gate_guide.png}}
                \caption[muEDM \gf: simulation of the entrance detector]{Geometry of the \gf simulation for the entrance detector in a simpler form \textbf{(a)} and a realistic setup, with an optical guide to which the SiPM are glued with optical grease \textbf{(b)}}
            ...
            \begin{figure}   
                ...
                \hfill
                \subfloat[A \SI{128}{MeV\per c} $\Am$ has $E_k \approx \SI{60.3}{MeV}$.]{\includegraphics[height=5.5cm, keepaspectratio]{Figures/muEDM/Entrance/28mu_guide.png}\label{fig:muEDM:entrance:guide:28mu}}
                \caption[muEDM \gf: entrance detector $\g$ w/wo optical guide]{Number of collected photons fro positrons \textbf{(a)} and muons \textbf{(b)} with and without an optical guide.}
...
\label{sec:muEDM:tim}
    ...
    \subsection{Data taking}
        ...
        \begin{figure}   
            ...
            \caption[muEDM 2021: picture of the setup]{Picture of the setup and one of the MuPix10 (grey-colored square) mounted on the PCBs.}
...
\label{sec:muEDM:beamtime2022}
    ...
    \subsection{Data analysis}
        ...
        \begin{figure}   
            ...
            \caption[muEDM 2022: optical crosstalk in the telescope(s)]{In case optical crosstalk is present, the correlation of the charges measured by the different scintillators show interesting patterns. These are expected and found in the Shanghai telescope, and not in the Pisa version, due to small gaps in the system.}
            \label{fig:muEDM:bt2022:blobs}
        \end{figure}
...
\label{sec:muEDM:beamtime2023}
    ...
    \subsection{Data taking}
        ...
        \begin{figure}
            ...
            \caption[muEDM 2023: simulation and CAD design of the setup]{The support structure was developed to reduce stresses to the injection channel and the PSC magnet: \textbf{(a)} shows the \ansys studies, \textbf{(b)} the whole setup, \textbf{(c)} and \textbf{(d)} the detail of the US and DS detectors.}
    ...
    \subsection{Data analysis}
        ...
        \begin{figure}
            ...
            \caption[muEDM 2023: picture of the TOF measurements]{The \textit{short} and \textit{long} configurations, used to extract the main parameters of the TOF detectors.}
