...
\section{Bite-size theory}
    ...
    \subsection{Electric Dipole Moment}
        ...
        We will discuss the muon \gls{edm} in detail in the chapter dedicated to the muEDM experiment.\\
        \cite{edmasprobe}

\section{MISSING! Experimental status}
    ...
    \subsection{MISSING! CLFV experiments}
        \subsubsection{MEG}
        \subsubsection{Mu3e}
        \subsubsection{Mu2e}
        \subsubsection{COMET}
    \subsection{MISSING! EDM experiments}
        \label{sec:exp:edm}
        \subsubsection{nEDM}
            \paragraph{n2EDM}
        \paragraph{eEDM}
...
\section{The beams at PSI}
    ...
    \subsection{High-Intensity Proton Accelerator facility}
        ...
        \begin{outline}
            ...
            \1 Protons are then accelerated in three stages
                \2 From \SI{60}{keV} to \SI{870}{keV} by the CW DC linear accelerator, shown in Fig.~\ref{fig:PSI:CW}\\
                ...
                \2 The beam is sent to the Ring cyclotron. Eight magnets keep the particles on the spiral path and four cavities accelerate the beam up to \SI{590}{MeV}
    ...
    \subsection{MISSING! High-Intensity Muon Beams}
    \cite{HIMB:2021} 
