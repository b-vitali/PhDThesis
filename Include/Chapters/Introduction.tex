...
\section{Experimental status}
    ...
    \subsection{\gls{clfv} experiments}
        ...
        \begin{table}[!h]
            ...
            \hline
            Current limit &
            \makecell{$3.1 \times 10^{-13} (*)$ \\ MEG II \cite{MEG_II:physics}} &
            ...
            \makecell{Mu3e \cite{Papa}\cite{Mu3e:2014}\cite{Mu3e:2016}} &
            \makecell{Mu2e \cite{mu2e_proposal} \cite{MTDR}\cite{Mu2e:2022}\\ COMET \cite{COMET_2009}\cite{COMET_2012}\cite{COMET_2012_2}\cite{COMET_I}} \\
            \hline
            Planned sensitivity &
            $\sim 6\times 10^{-16}$&
            $\sim 10^{-16}$&
            ...
            \hline
            \end{tabular}
            \caption[CLFV searches with muons]{Overview of muon CLFV experiments. \\(*) The current limit recently surpassed the one set by MEG, $4.2 \times 10^{-13}$ \cite{MEG}.}
        \label{T_CLFV_mu}
        \end{table}
...
\end{figure}
    ...
    \subsection{EDM experiments}
        ...
        \subsubsection{Neutron: nEDM}
            ...
            \begin{figure}
                \centering
                \subfloat[Two vertically stacked storage chambers, filled with polarized UCNs and Hg atoms, are embedded in the same vertical magnetic field B, but with opposite electric-field directions E]{\includegraphics[width = 0.8\textwidth]{Figures/Introduction/n2EDM.png}               \label{fig:n2EDM}}\\
                \subfloat[The full CAD view of the n2EDM setup, with the core components.]{\includegraphics[width = 0.8\textwidth]{Figures/Introduction/n2EDM_whole.png}               \label{fig:n2EDM_whole}}
        ...
        \subsubsection{Electron}
            ...
            \begin{figure}
                ...
                \caption[EDM: ACME experiment]{Schematic of the ACME measurement. A  \ce{ThO} beam enters a $E,B$ fields region, where the spin is aligned with $\hat{x}$.
        ...
        \begin{figure}
            ...
            \caption[EDM: $g-2$ ring and EDM detector]{Sketches of the g-2 storage ring and the detector used to measure the muon EDM.}
        \end{figure}

        \begin{figure}
            \centering
            \includegraphics[width = 0.8\textwidth]{Figures/Introduction/muEDM_TB.png}
            \caption[EDM: $g-2$ Traceback Wire Chambe]{The Traceback Wire Chamber is the most complex detector added for the EDM measurement. It consists of eight three-layer drift tube planes to propagate the positron track back to the decay point.}
            \label{fig:g-2:TWC}
        \end{figure}             
