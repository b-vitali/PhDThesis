...
\end{figure}
    ...
    \subsection{EDM experiments}
        ...
        \begin{figure}
            ...
            \caption[$g-2$ ring and EDM detector]{Sketches of the g-2 storage ring and the detector used to measure the muon EDM.}
        \end{figure}

        \begin{figure}
            \centering
            \includegraphics[width = 0.8\textwidth]{Figures/Introduction/muEDM_TB.png}
            \caption[$g-2$ Traceback Wire Chambe]{The Traceback Wire Chamber is the most complex detector added for the EDM measurement. It consists of eight three-layer drift tube planes to propagate the positron track back to the decay point.}
            \label{fig:g-2:TWC}
        \end{figure}             
    ...
    \subsection{Meson production}       
        ...
        \begin{table}[]
            ...
            \begin{tabular}{|c|c|c|c|c|}
                 ...
                 \hline
            \end{tabular}
            \caption[Rates at the meson facilities]{Particle types available at the meson facilities. The rate in particles per second per \SI{1}{mA} of proton}
