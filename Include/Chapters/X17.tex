...
\section{ATOMKI and the X17 `anomaly'}
    ...
    \subsection{The process}
        ...
        \begin{figure}
            \centering
            \subfloat[]{\includegraphics[height = 4cm]{Figures/X17/Be_levels.png}}
            \subfloat[]{\includegraphics[height = 4cm]{Figures/X17/Be_levels_mixing.png}\label{fig:X17:states:b}}          
            \caption{}
...
\section{X17 in MEG II}
    ...
    \subsection{Target}
        ...
        Among the options studied, \ce{LiF} and \ce{Li_{3.6}PO_{3.4}N_{0.6}}\footnote{The fraction of the different atoms depends on the production process, which in this instance was \textit{sputtering}. These were the values measured for the target produce at PSI.} were the most promising.
        ...
        Some data was acquired using the \ce{LiF} target but the Fluorine has a resonance at \SI{6.13}{MeV}, \SI{6.92}{MeV}, and \SI{7.12}{MeV} with a cross-section much higher than the one of the Lithium.
