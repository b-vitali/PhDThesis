...
\section{Spectrometer}
    ...
    \subsection{pixelated Timing Counter (pTC)}
        ...
        \begin{figure}
            ...
            \caption[pTC: picture of a tile]{A pTC tile: $120\times40/50\times5$ mm$^3$ of \bc{422} read by arrays of 6 AdvanSiD $3\times3$ mm SiPM.}
...
\section{Sensitivity}  
    ...
    \begin{figure}   
        ...
        \hfill
        \subfloat[Example CDCH heat map.]{            \includegraphics[height=6.6cm]{Figures/MEG/CDCH_example.png}}
    ...
    \subsection{Description of the machine}
       ...
       \begin{figure}
        ...
        \begin{figure}
            ...
            \caption[CW: picture]{View of the CW after the extraction from the external volume. This volume contains \ce{SF6} which is used as a gaseous dielectric medium and needs to be evacuated before the extraction.}
            \label{fig:CW:view}
        \end{figure}
