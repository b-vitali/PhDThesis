...
\section{Charge EXchange reaction}
    ...
    \centering
        ...
        \caption[CEX: Sketch and BGO]{Diagram of the CEX measurement, with the back-to-back photons configuration to define the XEC patch via the BGO positioning (\ref{fig:CEX:sketch}) Picture of the BGO detector (\ref{fig:CEX:bgo}) Picture of the BGO mover (\ref{fig:CEX:mover}).}
        \label{fig:CEX}
    \end{figure}
...
\section{BGO}
    ...
    Given the high Z ($Z_{Bi}=83$) and high density, this material is a very good $\g$ absorber (properties are listed in Tab.~\ref{tab:BGO:properties}).
    ...
    Key aspects of this detector are the calibration and inter-calibrations of the different crystals, discussed in App.~\ref{ch:BGO}\footnote{I worked on this item with David St\"{a}ger, a student from ETH, who collected these informations in his thesis \cite{David}}.
...
\section{2021}
    ...
    \subsection{Data anlaysis}
        ...
        \begin{figure}[]   
            \centering
            \subfloat[Time resolution of the XEC, obtained via the time difference of XEC and \textit{pre-shower} fitted with a double Gaussian.]{            \includegraphics[height=6cm]{Figures/MEG/XEC_t_resolution.png}\label{fig:LH2:XEC:resolution:t}}
            \hfill
            \subfloat[Energy resolution of the XEC.  The function used is Eq.~\ref{eq:XEC:E}.]{\includegraphics[height=6cm]{Figures/MEG/XEC_E_resolution.png}\label{fig:LH2:XEC:resolution:E}}
...
\section{2022}
    ...
    \subsection{Upgrades}
        ...
        \begin{figure}
            ...
            \caption[CEX 2022: \lakeshore sensors]{Pictures taken while mounting the \lakeshore sensors.}
...
\section{2023}
    ...
    \subsection{Tests}
        ...
        \begin{figure}[]   
            \centering
            \subfloat[New cooler]{\includegraphics[height = 6.5cm, keepaspectratio]{Figures/LH2/2023/new_cooler.png}\label{fig:CEX:2023:newcooler}}
            \hfill
            \subfloat[New cell]{\includegraphics[height = 6.5cm, keepaspectratio]{Figures/LH2/2023/new_cell.png}\label{fig:CEX:2023:newcell}}
            \hfill
            \subfloat[CAD of the new cell]{\includegraphics[height = 6.5cm, keepaspectratio]{Figures/LH2/2023/CAD_cell2023.png}\label{fig:CEX:2023:CADnewcell}}
        ...
        \begin{figure}[]   
            \centering
            \subfloat[Picture of the `compact' \ce{LH2}.]{\includegraphics[height = 6cm, keepaspectratio]{Figures/LH2/2023/LH2_compact.jpg}\label{fig:CEX:2023:target:shielding}}
            \hfill
            \subfloat[Super-insulation added on the cell.]{
            \includegraphics[height = 6cm, keepaspectratio]{Figures/LH2/2023/LH2_cellMLI.jpeg}\label{fig:CEX:2023:target:ML}}
            \caption[CEX 2023: 'Compact' target with insulation]{The `compact' version of the \ce{LH2} target is shown in (a), with the Cu shield on the cooler, the new vetronite parts and the super-insulation on the different sections. An additional layer of super-insulation was placed on the cell itself (b) to reduce the heat-lode due to radiation of the vacuum pipe.}
            
        \end{figure}

        \begin{figure}[]   
            \centering
            \subfloat[The sensor placed on the He lines with a Cu `clamp'.]{\includegraphics[height = 6.5cm, keepaspectratio]{Figures/LH2/2023/CEX2023_sensors_inlet.jpg}}
            \hfill
            \subfloat[An additional sensors on the cell]{
            \includegraphics[height = 6.5cm, keepaspectratio]{Figures/LH2/2023/LH2_cellSensor.jpg}}
        ...
        \begin{figure}[]   
            ...
            \caption[CW 2023: a successful test]{This plot illustrates the outcome of a successful liquefaction process. The azure line depicts the fill level of the cell. The repeated drops in the line signify that the test aimed to decrease the Helium flux while maintaining the presence of liquid Hydrogen.}
...
\section{Conclusions}
    ...
    Although being still far from any shade of \textit{expertise}, this has been quite an eye-opening endeavor.
        ...
        \begin{figure}[]   
            ...
            \caption[CEX: Triggered events per patch in 2021/2022/2023]{Number of triggered events during Charge EXchange data taking in 2021 2022 and 2023. Notice the lack of events in 3 patches in 2021 due to the low dutycycle of the LH2 target. For 2022 and 2023, the required statistics was collected and exceeded.}
    ...
    \centering
        ...
        The low duty cycle prevented the collection of the necessary statistics for every patch.]{\includegraphics[width=0.9\textwidth, height=6cm]{Figures/LH2/2021CEX_LH2.png}\label{fig:CEX:datataking:2021}}\\
